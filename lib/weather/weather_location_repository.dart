...
typedef WeatherLocationSelector = Future<List<Map<String, dynamic>>> Function();
typedef WeatherLocationInserter =
    Future<Map<String, dynamic>> Function(Map<String, dynamic> row);
typedef WeatherLocationUpdater =
...
class WeatherLocationRepository {
  ...
  Future<WeatherSavedLocation> update({
    ...
    try {
      ...
      throw WeatherLocationException('Could not update this location: $error');
    }
  }
  ...
  Future<void> delete(String id) async {
    try {
      ...
      throw WeatherLocationException('Could not delete this location: $error');
    }
  }
}
